...
using Xamarin.Forms;
using SocietyPass.Mobile.Core.Styles;

namespace SocietyPass.Mobile.Core.Views
{
	public partial class Rating : ContentView
	{
		private string RATING_EMPTY_ICON_CHAR 	= SocietyPassShapesFont.StarBorder;
		private string RATING_PARTIAL_ICON_CHAR = SocietyPassShapesFont.StarHalf;
		private string RATING_FULL_ICON_CHAR	= SocietyPassShapesFont.Star;
