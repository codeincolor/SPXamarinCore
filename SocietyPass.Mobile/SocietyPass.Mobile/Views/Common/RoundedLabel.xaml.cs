...
namespace SocietyPass.Mobile.Core.Views
{
	public partial class RoundedLabel : ContentView
	{
		...
		public static BindableProperty RoundedLabelLineBreakModeProperty =
			BindableProperty.Create(
				nameof(RoundedLabelLineBreakMode),
				typeof(LineBreakMode),
				typeof(RoundedLabel),
				defaultValue: LineBreakMode.TailTruncation,
				defaultBindingMode: BindingMode.OneWay
			);

		public LineBreakMode RoundedLabelLineBreakMode
		{
			get { return (LineBreakMode)GetValue(RoundedLabelLineBreakModeProperty); }
			set { SetValue(RoundedLabelLineBreakModeProperty, value); }
		}
	}
}
